...
def seed_demo_tenants():
    ...
    print(f"✅ Amotek created (ID: {amotek.id})")
    ...
    print(f"✅ Amotek admin: admin@amotek.com / amotek123")
    ...
    for ec_data in end_customers_amotek:
        ...
        print(f"  ✅ End customer: {ec_data['company_name']}")
    ...
    print(f"✅ IMA admin: admin@ima.it / ima123")
    ...
    print("\n✅ Demo tenants seeded successfully!")
    print("\n" + "="*60)
...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        if existing:
            print("⚠️  Demo tenants already exist!")
